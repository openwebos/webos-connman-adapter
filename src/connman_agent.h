...
typedef GVariant* (*connman_agent_request_input_cb)(GVariant *fields, gpointer user_data);
typedef void (*connman_agent_report_error_cb)(const char *error_message, gpointer user_data);
...
void connman_agent_set_report_error_cb(connman_agent_t *agent, connman_agent_report_error_cb cb, gpointer user_data);
